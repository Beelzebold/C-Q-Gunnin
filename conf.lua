function love.conf(t)
	t.identity = "nikowa_cqgunnin"      -- The name of the save directory (string)
	t.appendidentity = true             -- Search files in source directory before save directory (boolean)
	t.version = "11.4"                  -- The LÖVE version this game was made for (string)
	
	t.window.title = "CQGunnin'"        -- The window title (string)
	t.window.icon = "cqg.png"                 -- Filepath to an image to use as the window's icon (string)
	t.window.width = 300*3              -- The window width (number)
	t.window.height = 224*3             -- The window height (number)
